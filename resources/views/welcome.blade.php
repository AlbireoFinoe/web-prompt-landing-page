            ...
            <div class="flex items-center gap-4">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl transition shadow-lg shadow-blue-600/30">Start for Free</a>
                    @endif
                @endauth
            </div>
        @endif
    ...
    <main class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <h1 class="text-6xl md:text-7xl font-extrabold tracking-tight mb-8 leading-tight">
                Create <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">High-Converting</span> Sales Pages in Seconds.
            </h1>
            
            <p class="text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                Leave the old way of copywriting behind. Simply enter your product name and a short description, and let our AI craft a persuasive structure to boost your sales.
            </p>
