                ...
                @if($content)
                        ...
                        <div class="max-w-4xl mx-auto">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                @foreach($content['pain_points'] as $pain)
                                    <div class="bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-slate-100 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="py-24 px-8 md:px-16 max-w-6xl mx-auto">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    @if(isset($content['features']) && is_array($content['features']))
                                        @foreach($content['features'] as $feature)
                                            <div class="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:bg-white hover:shadow-md transition-all">
                            ...
                            <div class="lg:col-span-2 space-y-8 sticky top-8">
